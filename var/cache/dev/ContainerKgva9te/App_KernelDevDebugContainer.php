...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\API\\AdminApiController' => 'getAdminApiControllerService',
            'App\\Controller\\API\\ClientApiController' => 'getClientApiControllerService',
            'App\\Controller\\API\\CommandeController' => 'getCommandeControllerService',
            'App\\Controller\\API\\IngredientApiController' => 'getIngredientApiControllerService',
            'App\\Controller\\API\\PlatApiController' => 'getPlatApiControllerService',
            'App\\Controller\\API\\RecetteApiController' => 'getRecetteApiControllerService',
            'App\\Controller\\API\\RelationIngredientRecetteController' => 'getRelationIngredientRecetteControllerService',
            'App\\Controller\\API\\RelationplatCommandeController' => 'getRelationplatCommandeControllerService',
            'App\\Controller\\API\\StockApiController' => 'getStockApiControllerService',
        ...
        $this->privates['service_container'] = static function ($container) {
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'EventListener'.\DIRECTORY_SEPARATOR.'TokenListener.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Service'.\DIRECTORY_SEPARATOR.'JwtTokenManager.php';
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.controller', [#[\Closure(name: 'App\\EventListener\\TokenListener')] fn () => ($container->privates['App\\EventListener\\TokenListener'] ?? self::getTokenListenerService($container)), 'onKernelController'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\API\\AdminApiController', 'App\\Controller\\API\\ClientApiController', 'App\\Controller\\API\\CommandeController', 'App\\Controller\\API\\IngredientApiController', 'App\\Controller\\API\\PlatApiController', 'App\\Controller\\API\\RecetteApiController', 'App\\Controller\\API\\RelationIngredientRecetteController', 'App\\Controller\\API\\RelationplatCommandeController', 'App\\Controller\\API\\StockApiController', 'App\\Controller\\HomeController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    /**
     * Gets the private 'App\EventListener\TokenListener' shared autowired service.
     *
     * @return \App\EventListener\TokenListener
     */
    protected static function getTokenListenerService($container)
    {
        return $container->privates['App\\EventListener\\TokenListener'] = new \App\EventListener\TokenListener(($container->privates['App\\Service\\JwtTokenManager'] ??= new \App\Service\JwtTokenManager($container->getEnv('JWT_SECRET_KEY'))));
    }
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'jwt_secret' => $container->getEnv('JWT_SECRET'),
