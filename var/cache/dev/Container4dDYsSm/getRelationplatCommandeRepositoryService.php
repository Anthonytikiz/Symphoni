 ...
 */
class getRelationplatCommandeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RelationplatCommandeRepository' shared autowired service.
     *
     * @return \App\Repository\RelationplatCommandeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RelationplatCommandeRepository.php';

        return $container->privates['App\\Repository\\RelationplatCommandeRepository'] = new \App\Repository\RelationplatCommandeRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
