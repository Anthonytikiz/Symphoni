 ...
 */
class getStockIngredientRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\StockIngredientRepository' shared autowired service.
     *
     * @return \App\Repository\StockIngredientRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StockIngredientRepository.php';

        return $container->privates['App\\Repository\\StockIngredientRepository'] = new \App\Repository\StockIngredientRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
