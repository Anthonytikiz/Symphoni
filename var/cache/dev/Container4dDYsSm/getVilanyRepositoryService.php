 ...
 */
class getVilanyRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VilanyRepository' shared autowired service.
     *
     * @return \App\Repository\VilanyRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VilanyRepository.php';

        return $container->privates['App\\Repository\\VilanyRepository'] = new \App\Repository\VilanyRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
