 ...
 */
class getRelationIngredientRecetteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RelationIngredientRecetteRepository' shared autowired service.
     *
     * @return \App\Repository\RelationIngredientRecetteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RelationIngredientRecetteRepository.php';

        return $container->privates['App\\Repository\\RelationIngredientRecetteRepository'] = new \App\Repository\RelationIngredientRecetteRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
